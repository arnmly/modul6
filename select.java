...
class Select extends AppCompatActivity implements View.OnClickListener{
    ...
    private void showMahasiswa(String json){ try {
    ...
    private void updateMahasiswa(){
        ...
        class UpdateMahasiswa extends AsyncTask<Void,Void,String>{ ProgressDialog loading;
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1){
                        deleteMahasiswa();
                        startActivity(new Intent(Select.this, RequiresPermission.Read.class));
                    } });
